...
async def _(event):
    zzevent = await edit_or_reply(event, "❃ عٍزْيزْي [{tag}](tg://user?id={user.id}) \n❃ الُِبَوُبَ هوُ مطُوُرٍي لُِلُِتوُاصلُِ معٍ هذَا هوُ اسم الُِمستخـدِم الُِخـاص بَه @P_O28\n❃ شُڪرٍا لُِستخـدِامڪ سوُرٍس فُلُِاشُ 🖤🌚")