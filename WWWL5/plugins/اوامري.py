...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر فلاش
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == WWWL5.uid:
            buttons = [
                [Button.inline("معلومات فلاش", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس فلاش هذه بعض المعلومات عن فلاش :

- سورس فلاش يمتلك اكثر من 100 أمر 
- فلاش هو افضل سورس عربي يتميز بالحماية

قـنـاة الـكـلايــش: @EE_74
قـنـاة الشروحات: @X_koo
قـنـاة الـســورس: @FLS_44
