...
c = requests.session()
bot_username = '@srwry2bot'
tepthon = ['yes']


@WWWL5.on(admin_cmd(pattern="(تجميع اليمن|تجميع يمن)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await WWWL5.send_message('@srwry2bot', '/start')
        await asyncio.sleep(5)
        msg0 = await WWWL5.get_messages('@srwry2bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await WWWL5.get_messages('@srwry2bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await WWWL5.get_messages('@srwry2bot', limit=1)
