...
@WWWL5.ar_cmd(
    ...
    info={
        "header": "Source code link of WWWL5",
        "usage": [
            "{tr}repo",
        ],
    },
...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "اضغط [هنا](t.me/FLS_44) لفتح قناة السورس\
        \nاضغط [هنا](t.me/FLS_45) جروب الدعم",
    )
...
@WWWL5.ar_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **WWWL5/plugins** folder\
...
async def git_commit(file_name, mone):
    ...
    if create_file:
        file_name = f"WWWL5/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/WWWL5/plugins/)"
            )
