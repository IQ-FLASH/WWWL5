...
@WWWL5.on(admin_cmd(pattern="(تجميع دعمكم|تجميع دعمك)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        msg0 = await WWWL5.get_messages('@DamKombot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await WWWL5.get_messages('@DamKombot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await WWWL5.get_messages('@DamKombot', limit=1)
