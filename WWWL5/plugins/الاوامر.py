...
async def hi(event):
    await edit_or_reply(
        event,
        "[ . ᯏ𝖲᥆υᖇᥴᥱ - 𝖥𝗅ᥲ᥉𝗁 ᭡ .](t.me/FLS_44)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n**❃ هـذه هي قائمة اوامـر سـورس فـلاش **\n\n❃ `.م1` ◂ اوامر الأدمن\n❃ `.م2` ◂ اوامر المجموعة\n❃ `.م3` ◂ اوامر الترحيب\n❃ `.م4` ◂ اوامر الردود\n❃ `.م5` ◂ اوامر الترفيه والرفع\n❃ `.م6` ◂ اوامر حماية الخاص\n❃ `.م7` ◂ اوامر الاذاعه و الكشف\n❃ `.م8` ◂ اوامر البوت\n❃ `.م9` ◂ اوامر النشر التلقائي\n❃ `.م10` ◂ اوامر المنع والترجمه\n❃ `.م11` ◂ اوامر التليجراف و النطق\n❃ `.م12` ◂ اوامر التحميل\n❃ `.م13` ◂ اوامر التكرار\n❃ `.م14` ◂ اوامر الانتحال والتقليد\n❃ `.م15` ◂ اوامـر الـسـاعـه\n❃ `.م16` ◂ اوامر الذاتيه والاضافه\n❃ `.م17` ◂ اوامر البروفايل\n❃ `.م18` ◂ اوامر الأكسترا\n❃ `.م19` ◂ التاك و الملفات\n❃ `.م20` ◂ اوامر الصيغ\n❃ `.م21` ◂ اوامر التسلية\n❃ `.م22` ◂ اوامر التحكم\n❃ `.م23` ◂ اوامر حماية المجموعة\n❃ `.م24` ◂ اوامر لعبة البنك و الخطوط\n❃ `.م25` ◂ اوامر تجميع النقاط\n❃ `.م26` ◂ اوامر الصيد و الالعاب\n❃ `.م27` ◂ اوامر الافتارات و البصمات\n❃ `.م28` ◂ اوامر الـمـيـمـز\n❃ `.م29` ◂  اوامر القرآن الكريم\n❃ `.م30` ◂ اوامر تحديثات السورس",
        link_preview=False,
    )


@WWWL5.ar_cmd(pattern="م1")
async def hi(event):
    await edit_or_reply(
        event,
...
async def hi(event):
    await edit_or_reply(
        event,
        "[ . ᯏ𝖲᥆υᖇᥴᥱ - 𝖥𝗅ᥲ᥉𝗁 ᭡ .](t.me/FLS_44)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n** قائمـه اوامر النشر التلقائي : **\n\n ◂  `.نشر`\n** ❃ نشر + عدد الثواني + معرف المجموعة < بالرد علي رسالة. **\n** ❃ يقوم بالنشر التلقائي في المجموعة التي وضعتها **\n\n ◂  `.نشر_كروبات`\n** ❃ .نشر_كروبات عدد الثواني < بالرد ع الرسالة **\n** ❃ يقوم بنشر التلقائي لجميع المجموعات في حسابك **\n\n ◂  `.سوبر`\n** ❃ .سوبر + عدد الثواني < بالرد على الرسالة**\n** ❃ يقوم بالنشر فقط في مجموعات السوبر **\n\n ◂  `.ايقاف النشر`\n** ❃ لايقاف جميع انواع النشر التي ذكرت في الاعلي **\n\n ◂  `.النشر` `تفعيل`|`تعطيل` \n** ❃ يقوم بتعطيل نشر التلقائي في المجموعة او تفعيله **",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "[ . ᯏ𝖲᥆υᖇᥴᥱ - 𝖥𝗅ᥲ᥉𝗁 ᭡ .](t.me/FLS_44)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n قائمـه اوامر المنع والترجمة :\n\n ◂  `.منع`\n❃ اكتب الامر مع الكلمه لمنع ارسالها في المجموعات\n\n ◂  `.الغاء منع`\n❃ اكتب الامر مع الكلمه لالغاء منعها من المجموعة\n\n ◂  `.قائمة المنع`\n❃ اكتب الامر لعرض قائمة الكلمات التي منعتها في المجموعة\n\n❃ لتفعيل امر الترجمة التلقائية\n❃ اكتب ◂ `.تفعيل الترجمة التلقائية`\n❃ للتعطيل اكتب ◂ `.تعطيل الترجمة التلقائية`\n\n◂  `.ترجمة`\n❃ يستخدم الامر لترجمه الكلمات اكتب الامر مع كود اللغه بالرد على النص لترجمته\n\n⌔∮ اكواد اللغات للترجمه  [اضغط هنا](https://telegra.ph/-11-19-1927)",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "[ . ᯏ𝖲᥆υᖇᥴᥱ - 𝖥𝗅ᥲ᥉𝗁 ᭡ .](t.me/FLS_44)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n قائـمة اوامـر الـسـاعـه :\n\n◂ `.تفعيل الساعه`\n❃ اكتب الامر لاضافة اسم وقتي حسب المنطقة التي وضعتها \n\n ◂ `.تعطيل الساعه`\n❃ لتعطيل الاسم الوقتي و ارجاع الاسم الطبيعي .\n\n ◂ `.بايو وقتي`\n❃ اكتب الامر لاضافة ساعه تتحرك مع البايو الخاصة بك  \n\n ◂ `.تعطيل بايو وقتي`\n❃ لتعطيل البايو الوقتي و ارجاع البايو الطبيعي\n\n ◂  `.الصورة الوقتية`\n❃ لبدء تشغيل وقت على الصورة الخاصة بحسابك\n\n ◂  `.تعطيل الصورة الوقتية`\n❃ لألغاء امر الصورة الوقتية \n\n ◂ `.الفارات`\n❃ لتغيير شكل الساعه اكتب هذا الامر",
    )
...
async def ae(event):
    await edit_or_reply(
        event,
        "[ . ᯏ𝖲᥆υᖇᥴᥱ - 𝖥𝗅ᥲ᥉𝗁 ᭡ .](t.me/FLS_44)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n قائـمة اوامـر الـمـيمـز\n\n◂ `.الميمز1`\n◂ `.الميمز2`\n◂ `.الميمز3`\n◂ `.الميمز4`\n\n❃ اضغط علي الامر وارسله للدخول الي قائمات الميمز",
        link_preview=False,
    )
