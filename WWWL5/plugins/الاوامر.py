...
async def hi(event):
    await edit_or_reply(
        event,
        "➥『 𝑆𝑂𝑈𝑅𝐶𝐸 𝐹𝐿𝐴𝑆𝐻 』𓄂⍣⃝ˑ༄ؘ ۪۪۫۫ ▹🇪🇬◃ ۪۪۫۫ ༄ؘ ˑ𓆃\n\nقائمـه اوامر المنع والترجمة :\n\n ◂  `.منع`\n⚡️ اكتب الاكر مع الكلمه لمنع ارساله في المجموعه او اي دردشه\n\n ◂  `.الغاء منع`\n⚡️ اكتب الامر مع الكلمه لالغاء منعها من الدردشه\n\n ◂  `.قائمة المنع`\n⚡️ اكتب الامر لعرض قائمه الكلمات التي منعتها في الدردشة\n\n⚡️ لتفعيل امر الترجمة التلقائية\n⚡️ اكتب ◂ `.تفعيل الترجمة التلقائية`\n⚡️ للتعطيل اكتب ◂ `.تعطيل الترجمة التلقائية`\n\n◂  `.ترجمة`\n⚡️ يستخدم الاكر لترجمه الكلمات اكتب الامر مع كود اللغه بالرد غلى النص لترجمته\n\n⌔∮ اكواد اللغات للترجمه  [اضغط هنا](https://telegra.ph/-11-19-1927)\n➥『 𝑆𝑂𝑈𝑅𝐶𝐸 𝐹𝐿𝐴𝑆𝐻 』𓄂⍣⃝ˑ༄ؘ ۪۪۫۫ ▹🇪🇬◃ ۪۪۫۫ ༄ؘ ˑ𓆃",
    )
