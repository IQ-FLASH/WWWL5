...
@WWWL5.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular WWWL5",
    },
)
...
@WWWL5.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي CatWWWL5 is One of the Popular WWWL5",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@WWWL5.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular WWWL5",
    },
)
async def nekobot(cat):
...
@WWWL5.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular WWWL5",
    },
)
async def nekobot(cat):
