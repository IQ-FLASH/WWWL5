...
@WWWL5.on(admin_cmd(pattern="كشف التناحه$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_Tna7h))

Jepthon_Tna7h = [
    "** ❃ تـم اكتشاف ان هذا الكائن تنح ولا يوجد له علاج الا الشبشب 😹 **",
    "** ❃ تـم اكتشاف ان هذا الكائن تنح ولا يوجد له علاج الا البلوك 😹 **",
    "** ❃ تـم اكتشاف ان هذا الكائن تنح ولا يوجد له علاج الا الضرب علي القفا 😹 **",
    "** ❃ لا مش تنح ده طيب خالص 🤍 **",
    "** ❃ كده عيب تعمل علية كشف زي ده مش هتلاقي اجدع منه 🌚🤍 **",
